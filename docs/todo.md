...
- RDKit rendering now materializes SMILES into SVG assets saved under `backend/app/report_assets/structures/`, exposes `payload.structure` metadata (svg/path/smiles/error), and embeds the preview in both the frontend dashboard and PDF export.
